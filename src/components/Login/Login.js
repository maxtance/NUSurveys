    ...
    const onFormSubmit = async (e) => {
        ...
        if (error) {
            ...
            if (error.message === "Invalid login credentials") {
                setError("password", { type: 'custom', message: error.message + ". Please try again" });
            }
        } else {
            ...
            <div className='col col-md-7' id={styles.formwrapper}>
                <h2 className={styles.formTitle}>Login</h2>
                    ...
                    >
                        ...
                        <br></br>
                        <div>
                            <small className={styles.signupBanner}>New to NUSurveys? <Link to="/register" className={styles.signup}>Sign up here</Link></small>
                        </div>
