        ...
        <div id={styles.createSurveyWindow}>
            ...
            <div class="row" id={styles.btnContainer}>
                <div class="col-md-1 offset-md-10">
                    <button class="btn" id={styles.resetBtn} type="reset" onClick={handleSubmit}>Cancel</button>
                </div>
                <div class="col-md-1">
                    <button class="btn" id={styles.submitBtn} onClick={handleSubmit}>Submit</button> 
                </div>
            </div>
        </div>
    )
