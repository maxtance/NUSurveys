        ...
        <div className="col col-md-7" id={styles.formwrapper}>
          ...
          >
            <div class="row">
              <div class="col-md-5">
                <div className="form-group">
                  <label for="firstName" className={styles.fieldName}>
                    First Name
                  </label>
                  <input
              ...
              <div class="col-md-5 offset-md-1">
                <div className="form-group">
                  <label for="lastName" className={styles.fieldName}>
                    Last Name
                  </label>
                  <input
            ...
            <div class="row">
              <div class="col-md-5">
                <div className="form-group">
                  <label for="gender" className={styles.fieldName}>
                    Gender
                  </label>
                  <select
              ...
              <div class="col-md-5 offset-md-1">
                <div className="form-group">
                  <label for="dob" className={styles.fieldName}>
                    Date of Birth
                  </label>
                  <br></br>
                  <input
            ...
            <div class="row">
              <div class="col-md-5">
                <div className="form-group">
                  <label for="ethnicity" className={styles.fieldName}>
                    Ethnicity
                  </label>
                  <select
                    name="ethnicity"
            ...
            <div class="row">
              <div className="form-group col-md-8">
                <label
                  for="email"
                  className={`${styles.fieldName} ${styles.email}`}
                >
                  Email
                </label>
                <br></br>
